...
<div class="page-content page-details">
  ...
  <!-- galery -->
  <section class="store-galery mb-3" id="galery">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-2">
          <div class="row">
            <div class="col-3 col-lg-12 mt-2 mt-lg-0" v-for="(photo,index) in photos" :key="photo.id" data-aos="zoom-in"
              data-aos-delay="100">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2" data-aos="zoom-in">
            ...
            @else
            <a href="{{ route('login') }}" class="btn btn-success px-4 text-white btn-block mb-3">Sign in tot add </a>
            @endauth
        ...
        <div class="row">
          <div class="col-12 col-lg-8">
            <ul class="list-unstyled">
              <li class="media">
                <img src="/images/icon-riview-1.png" alt="" class="mr-3 rounded-circle" />
                <div class="media-body">
                  <h5 class="mt-2 mb-1">Fitry Yani</h5>
                  I thought it was not good for living room. I really happy to decided buy this product last week now
                  feels like homey.
                </div>
              </li>
              <li class="media">
                <img src="/images/icon-riview-2.png" alt="" class="mr-3 rounded-circle" />
                <div class="media-body">
              ...
              <li class="media">
                <img src="/images/icon-riview-3.png" alt="" class="mr-3 rounded-circle" />
                <div class="media-body">
